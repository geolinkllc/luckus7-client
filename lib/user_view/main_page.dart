      ...
      body: SafeArea(
        child: InAppWebView(
          ...
          onCreateWindow: (controller, createWindowRequest) async {
            ...
            print("onCreateWindow ${createWindowRequest.request.url.toString()}");

            return await showCupertinoModalBottomSheet(context: context, builder: (context) {
          ...
          // initialUrlRequest: URLRequest(url: Uri.parse("https://m.cocodemer.co.kr")),
          // initialHeaders: {},
          initialOptions: InAppWebViewGroupOptions(
            crossPlatform: InAppWebViewOptions(
              supportZoom: false,
